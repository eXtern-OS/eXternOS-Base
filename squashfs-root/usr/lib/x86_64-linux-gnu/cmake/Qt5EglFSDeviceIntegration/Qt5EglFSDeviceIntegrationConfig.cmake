...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/Qt5EglFSDeviceIntegration" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5EglFSDeviceIntegration_install_prefix "/usr/lib/x86_64-linux-gnu/../../" ABSOLUTE)
else()
...
if (NOT TARGET Qt5::EglFSDeviceIntegration)
    ...
    set(Qt5EglFSDeviceIntegration_PRIVATE_INCLUDE_DIRS
        "${_qt5EglFSDeviceIntegration_install_prefix}/include/x86_64-linux-gnu/qt5/QtEglFSDeviceIntegration/5.13.2"
        "${_qt5EglFSDeviceIntegration_install_prefix}/include/x86_64-linux-gnu/qt5/QtEglFSDeviceIntegration/5.13.2/QtEglFSDeviceIntegration"
    )
    ...
    _populate_EglFSDeviceIntegration_target_properties(RELEASE "libQt5EglFSDeviceIntegration.so.5.13.2" "" FALSE)
