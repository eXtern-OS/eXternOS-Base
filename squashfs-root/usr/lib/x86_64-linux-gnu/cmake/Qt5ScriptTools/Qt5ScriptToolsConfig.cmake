...
set(Qt5ScriptTools_VERSION_STRING 5.13.2)
...
if (NOT TARGET Qt5::ScriptTools)
    ...
    set(Qt5ScriptTools_PRIVATE_INCLUDE_DIRS
        "${_qt5ScriptTools_install_prefix}/include/x86_64-linux-gnu/qt5/QtScriptTools/5.13.2"
        "${_qt5ScriptTools_install_prefix}/include/x86_64-linux-gnu/qt5/QtScriptTools/5.13.2/QtScriptTools"
    )
    ...
    foreach(_module_dep ${_Qt5ScriptTools_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.13.2 ${_Qt5ScriptTools_FIND_VERSION_EXACT}
    ...
    _populate_ScriptTools_target_properties(RELEASE "libQt5ScriptTools.so.5.13.2" "" FALSE)
