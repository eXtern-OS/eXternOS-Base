...
if (NOT TARGET Qt5::DBus)
    ...
    set(Qt5DBus_PRIVATE_INCLUDE_DIRS
        "${_qt5DBus_install_prefix}/include/x86_64-linux-gnu/qt5/QtDBus/5.13.2"
        "${_qt5DBus_install_prefix}/include/x86_64-linux-gnu/qt5/QtDBus/5.13.2/QtDBus"
    )
    ...
    _populate_DBus_target_properties(RELEASE "libQt5DBus.so.5.13.2" "" FALSE)
