...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/Qt5XcbQpa" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5XcbQpa_install_prefix "/usr/lib/x86_64-linux-gnu/../../" ABSOLUTE)
else()
...
set(Qt5XcbQpa_VERSION_STRING 5.13.2)
...
if (NOT TARGET Qt5::XcbQpa)
    ...
    foreach(_module_dep ${_Qt5XcbQpa_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.13.2 ${_Qt5XcbQpa_FIND_VERSION_EXACT}
    ...
    _populate_XcbQpa_target_properties(RELEASE "libQt5XcbQpa.so.5.13.2" "" FALSE)
