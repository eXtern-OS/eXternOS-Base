...
if (NOT TARGET Qt5::Sql)
    ...
    set(Qt5Sql_PRIVATE_INCLUDE_DIRS
        "${_qt5Sql_install_prefix}/include/x86_64-linux-gnu/qt5/QtSql/5.13.2"
        "${_qt5Sql_install_prefix}/include/x86_64-linux-gnu/qt5/QtSql/5.13.2/QtSql"
    )
    ...
    _populate_Sql_target_properties(RELEASE "libQt5Sql.so.5.13.2" "" FALSE)
