...
unless(defined(&_SYS_TYPES_H)) {
	...
	eval 'sub __SYSMACROS_DEPRECATED_INCLUSION () {1;}' unless defined(&__SYSMACROS_DEPRECATED_INCLUSION);
	require 'sys/sysmacros.ph';
	undef(&__SYSMACROS_DEPRECATED_INCLUSION) if defined(&__SYSMACROS_DEPRECATED_INCLUSION);
    }
